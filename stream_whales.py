...
# This script streams structured responses from GPT-4 about whales, 
# validates the data and displays it as a dynamic table using rich as the data is received.
...
agent = Agent('openai:gpt-4o', result_type=list[Whale])
